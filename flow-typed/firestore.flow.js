...
declare type LogLevel = 'debug' | 'error' | 'silent';
 ...
 */
declare interface DocumentListenOptions {
...
declare class DocumentReference {
  ...
  update(
    field: string | FieldPath,
    value: any,
    ...moreFieldsAndValues: any[]): Promise<void>;
 ...
 */
declare interface SnapshotMetadata {
 ...
 * snapshot listener.
 */
declare interface QueryListenOptions {
...
*/
declare class CollectionReference mixins Query {
  constructor(): this;
...
declare class FieldPath {
   ...
   */
  constructor(...fieldNames: string[]): this;
...
*/
declare type FirestoreErrorCode = 'cancelled' |
'unknown' |
'invalid-argument' |
'deadline-exceeded' |
'not-found' |
 ...
 */
declare interface FirestoreError {
