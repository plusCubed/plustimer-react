...
function dampenedHookeForce(displacement: number,
                            velocity: number,
                            stiffness: number,
                            damping: number) {
    //
...
function accumulateCurvePoints(x: number, velocity: number, mass: number, stiffness: number, damping: number) {
...
function generateAnimationCss(points: any[],
                              name: string,
                              duration: string,
